...
public class Graph_M
{
    ...
    {
        System.out.println("\t Patna Metro Map");
        System.out.println("\t------------------");
        System.out.println("----------------------------------------------------\n");
        ArrayList<String> keys = new ArrayList<>(vtces.keySet());
    ...
    {
        g.addVertex("New ISBT ~NI");
        g.addVertex("Zero Mile ~ZM");
        g.addVertex("Khemni Chak ~KC");
        g.addVertex("RamKrishna Nager ~RN");
        g.addVertex("Mithapur ~MM");
        g.addVertex("Patna Junction ~PJ");
        g.addVertex("Malahi Pakri ~MP");
        g.addVertex("Rajendra nager Terminal ~RnT");
        g.addVertex("Patna University ~PU");
        g.addVertex("PM CH ~PC");
        g.addVertex("Grandhi Maidan ~GM");
        g.addVertex("Aakashvani ~AA");
        g.addVertex("Vidyut Bhawan ~VB");
        g.addVertex("Vikash i Bhawan ~ViB");
        g.addVertex("Patna Zoo ~PZ");
        g.addVertex("Raja Bazaar ~RB");
        g.addVertex("Rukanpura ~RR");
        g.addVertex("Patli Putra ~PP");
        g.addVertex("Saguna More ~SM");
        g.addVertex("Danapur Cantonment ~DC");

        g.addEdge("New ISBT ~NI", "Zero Mile ~ZM", 2);
        g.addEdge("Zero Mile ~ZM", "Khemni Chak ~KC",4);
        g.addEdge("Khemni Chak ~KC", "RamKrishna Nager ~RN", 1);
        g.addEdge("RamKrishna Nager ~RN", "Mithapur ~MM", 5);
        g.addEdge("Mithapur ~MM", "Patna Junction ~PJ", 2);
        g.addEdge("Khemni Chak ~KC", "Malahi Pakri ~MP", 4);
        g.addEdge("Malahi Pakri ~MP", "Rajendra nager Terminal ~RnT", 2);
        g.addEdge("Rajendra nager Terminal ~RJ", "Patna University ~PU", 4);
        g.addEdge("Patna University ~PU", "PM CH ~PC", 1);
        g.addEdge("PM CH ~PC", "Grandhi Maidan ~GM", 4);
        g.addEdge("Grandhi Maidan ~GM", "Aakashvani ~AA", 2);
        g.addEdge("Aakashvani ~AA", "Patna Junction ~PJ", 2);
        g.addEdge("Patna Junction ~PJ", "Vidyut Bhawan ~VB", 3);
        g.addEdge("Vidyut Bhawan ~VB", "Vikash i Bhawan ~ViB", 2);
        g.addEdge("Vikash i Bhawan ~ViB", "Patna Zoo ~PZ", 7);
        g.addEdge("Patna Zoo ~PZ", "Raja Bazaar ~RB", 2);
        g.addEdge("Raja Bazaar ~RB", "Rukanpura ~RR", 2);
        g.addEdge("Rukanpura ~RR", "Patli Putra ~PP", 6);
        g.addEdge("Patli Putra ~PP", "Saguna More ~SM", 15);
        g.addEdge("Saguna More ~SM", "Danapur Cantonment ~DC", 3);
    }
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        System.out.println("\n\t\t\t-*-*-*- WELCOME TO THE PATNA METRO APP -*-*-*-\n");
        ...
        while(true)
        {
            ...
            System.out.println("1. List All The Stations In The MAP");
            System.out.println("2. Show The PATNA METRO MAP");
            System.out.println("3. Get ShorTest DISTANCE FROM A 'SOURCE' STATION TO 'DESTINATION' STATION");
            System.out.println("4. Get ShorTest TIME TO REACH FROM A 'SOURCE' STATION TO 'DESTINATION' STATION");
            System.out.println("5. Get ShorTest PATH (DISTANCE WISE) TO REACH FROM A 'SOURCE' STATION TO 'DESTINATION' STATION");
            System.out.println("6. Get ShorTest PATH (TIME WISE) TO REACH FROM A 'SOURCE' STATION TO 'DESTINATION' STATION");
